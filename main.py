...
class RestaurantOrderManegement:
    def __init__(self,root):
        ...
        ttk.Label(frame,text="Restaurant Order Manegement",font=("Arial",20,"bold")).grid(row=0,columnspan=3,padx=10,pady=10)
        ...
        for i,(item,price) in enumerate(self.menu_items.items(),start=1):
            label=ttk.Label(frame,
                            text=f"{item} (${price}):",font=("Arial",12))
